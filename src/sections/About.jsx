...
const About = () => {
  ...
  return (
    <section id="about" className="min-h-screen flex items-center justify-center border-y border-gray-100 py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full flex flex-col md:flex-row gap-16 md:gap-24">

        {/* Left Side: Sticky/Static Header */}
        <div className="md:w-1/3 flex flex-col justify-start">
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-light text-gray-900 tracking-tight mb-6 leading-tight">
        ...
        <div className="md:w-2/3 flex flex-col">
          <div className="border-t border-gray-200">
            {features.map((feature, index) => (
              <div
                key={index}
                className="group flex flex-col sm:flex-row sm:items-start gap-6 sm:gap-10 py-10 border-b border-gray-200 hover:bg-gray-50/50 transition-colors duration-500 cursor-default"
              >
                ...
                <div className="flex-1">
                  <h3 className={`text-2xl font-medium text-gray-900 mb-3 tracking-tight group-hover:text-transparent group-hover:bg-clip-text transition-all duration-300 ${feature.gradientClass}`}>
                    {feature.title}
                  </h3>

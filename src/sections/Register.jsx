    ...
    <section id="register" className="py-16 sm:py-20 md:py-24 bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white border border-gray-200 rounded-3xl p-8 sm:p-12 md:p-16 lg:p-20 text-center shadow-sm">
          ...
          <p className="text-base sm:text-lg text-gray-600 mb-8 sm:mb-10 md:mb-12 max-w-xl mx-auto leading-relaxed font-normal">
          ...
          <p className="mt-8 sm:mt-10 text-gray-400 text-xs sm:text-sm font-mono">

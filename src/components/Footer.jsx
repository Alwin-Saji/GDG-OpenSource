      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start gap-10 md:gap-16 mb-16">
          ...
          <div className="flex flex-col items-start max-w-sm">
            ...
            <a href="/projects" className="inline-flex items-center gap-2 border border-transparent hover:border-black rounded-xl py-2 px-4 text-sm font-semibold text-black/60 hover:text-black transition-colors group">
          ...
          <div className="flex flex-wrap gap-12 sm:gap-20">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><a href="/#about" className="text-sm text-gray-500 hover:text-black transition-colors">About</a></li>
                <li><a href="/#workflow" className="text-sm text-gray-500 hover:text-black transition-colors">Workflow</a></li>
                <li><a href="/#leaderboard" className="text-sm text-gray-500 hover:text-black transition-colors">Leaderboard</a></li>
                <li><a href="/#faq" className="text-sm text-gray-500 hover:text-black transition-colors">FAQ</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><Link to="/contributor-guidelines" className="text-sm text-gray-500 hover:text-black transition-colors">Contributors</Link></li>
                <li><Link to="/maintainer-guidelines" className="text-sm text-gray-500 hover:text-black transition-colors">Maintainers</Link></li>
              ...
              <ul className="space-y-4">
                <li>
                  <a href="tel:+18001234567" className="flex items-start gap-3 group">
                    <FaPhoneAlt className="text-gray-400 mt-0.5 group-hover:text-black transition-colors" size={14} />
                    <div className="flex flex-col">
                      <span className="text-sm font-medium text-black">Phone</span>
                      <span className="text-sm text-gray-500 group-hover:text-black transition-colors">+1 (800) 123-4567</span>
                    </div>
                  </a>
                </li>
                <li>
                  {/* <a href="mailto:hello@gdg-opensource.com" className="flex items-start gap-3 group">
                    <FaEnvelope className="text-gray-400 mt-0.5 group-hover:text-black transition-colors" size={14} />
                    <div className="flex flex-col">
        ...
        {/* Bottom Section */}
        <div className="pt-8 border-t border-gray-100 flex flex-col-reverse sm:flex-row justify-between items-center gap-6">

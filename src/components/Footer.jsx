...
const Footer = () => {
  return (
    <footer className="pt-16 sm:pt-20 pb-8 sm:pb-10 mt-8 sm:mt-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        
        {/* Main Footer Content */}
        <div className="flex flex-col md:flex-row justify-between items-start gap-8 sm:gap-10 md:gap-16 mb-12 sm:mb-16">
          ...
          {/* Links grid */}
          <div className="flex flex-wrap gap-8 sm:gap-12 md:gap-20 w-full md:w-auto">
            {/* Nav Links */}
            <div>
            ...
            {/* Contact Info */}
            <div>
              <h4 className="text-black font-semibold mb-3 sm:mb-4 text-xs sm:text-sm">Contact</h4>
              <ul className="space-y-3 sm:space-y-4">
                ...
                <li>
                  <a href="https://maps.google.com/?q=College+of+Engineering+Chengannur" target="_blank" rel="noopener noreferrer" className="flex items-start gap-2 sm:gap-3 group">
                    ...
                    <div className="flex flex-col">
                      <span className="text-xs sm:text-sm font-medium text-black">Location</span>
                      <span className="text-xs sm:text-sm text-gray-500 group-hover:text-black transition-colors">College of Engineering Chengannur,<br/>Alappuzha, Kerala - 689121</span>
                    </div>
                  </a>
                </li>
              </ul>

      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start gap-10 md:gap-16 mb-16">
          ...
          <div className="flex flex-col items-start max-w-sm w-full">
            ...
            <a href="#" className="inline-flex items-center gap-2 border border-white/40 hover:border-white rounded-full py-2 px-4 text-xs sm:text-sm font-semibold text-white/80 hover:text-white transition-colors group">
